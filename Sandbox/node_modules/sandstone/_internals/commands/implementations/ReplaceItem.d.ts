...
export declare class ReplaceItem extends Command {
     ...
     */
    block: (pos: Coordinates, slot: CONTAINER_SLOTS, item: LiteralUnion<ITEMS>, count?: number | undefined) => void;
    /**
     ...
     * @param count Specifies the number of items to be placed.
     */
    entity: (targets: MultipleEntitiesArgument, slot: ENTITY_SLOTS, item: LiteralUnion<ITEMS>, count?: number | undefined) => void;
}
