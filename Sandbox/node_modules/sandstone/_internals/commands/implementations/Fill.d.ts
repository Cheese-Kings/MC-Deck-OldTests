...
export declare class FillArguments extends Command {
    /**
...
export declare class Fill extends Command {
     ...
     */
    fill: (from: Coordinates, to: Coordinates, block: LiteralUnion<BLOCKS>) => typeof FillArguments;
}
