import type { Coordinates } from "../../arguments/index";
import { Command } from "../Command";
/** These commands control the world border. */
export declare class WorldBorder extends Command {
    /**
     ...
     */
    damageAmount: (damagePerBlock: number) => void;
    /**
     ...
     */
    damageBuffer: (distance: number) => void;
    /**
     ...
     * If not specified, defaults to 0.
     */
    set: (distance: number, time?: number | undefined) => void;
    /**
