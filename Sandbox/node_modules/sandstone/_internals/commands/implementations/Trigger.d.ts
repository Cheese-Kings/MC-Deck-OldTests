import type { ObjectiveArgument } from "../../arguments/index";
import { Command } from "../Command";
export declare class TriggerArguments extends Command {
    /**
...
export declare class Trigger extends Command {
    /**
     ...
     * trigger(myObjective).add(2)
     */
    trigger: (objective: ObjectiveArgument) => TriggerArguments;
}
