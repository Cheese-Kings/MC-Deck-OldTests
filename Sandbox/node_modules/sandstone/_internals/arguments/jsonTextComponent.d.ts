...
declare type InteractivityTags = {
 ...
 */
export declare type TextComponentObject = ((ContentTag | {}) & ChildrenTags & FormattingTags & InteractivityTags);
/**
 * All possible chat components
 */
declare type PossibleComponent = (string | boolean | number | TextComponentObject | ComponentClass);
export declare type JsonTextComponent = (readonly PossibleComponent[] | PossibleComponent);
export {};
